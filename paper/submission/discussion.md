...
[van Staa 2000; Fardet 2011], so a 10% change in use should change notifications by about 0.3%, and
recorded steroid-associated immunosuppression implies less [UKHSA 2025]. Screening for latent
infection before anti-TNF therapy has been standard since 2005 [BTS 2005] and largely removes the
excess risk [Carmona 2005], so the risk relevant to a marginal increase in biologic use is small.
...
information lies [Gunasekara 2014], while power in aggregate studies depends mainly on the number of
areas [Sheppard 1996], which cannot be increased. Third, the linkage attenuates: the positive
...
Area-level adjustment also cannot remove cross-level bias [Greenland 1989; Morgenstern 1995]: people
...
TB meningitis and pericarditis [Thwaites 2004], further complicate same-year associations, which is
...
emulation, and even national cohorts give wide intervals for modest relative risks [Pealing 2015];
the only drug–TB target trial emulation we identified concerned DPP-4 inhibitors [Chen 2025].

These null results do not mean the drugs are safe. Glucocorticoids, biologics and JAK inhibitors
remain important treatments, and drug-associated TB is serious, often extrapulmonary [Keane 2001]
